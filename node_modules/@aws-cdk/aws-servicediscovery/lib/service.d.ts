 ...
 */
export declare class Service extends cdk.Construct implements IService {
    /**
     * A name for the Cloudmap Service.
     */
    readonly serviceName: string;
     ...
     */
    registerLoadBalancer(id: string, loadBalancer: route53.IAliasRecordTarget, customAttributes?: {
        [key: string]: string;
    }): IInstance;
    /**
     * Registers a resource that is accessible using values other than an IP address or a domain name (CNAME).
     */
    registerNonIpInstance(props: NonIpInstanceBaseProps): IInstance;
    /**
     * Registers a resource that is accessible using an IP address.
     */
    registerIpInstance(props: IpInstanceBaseProps): IInstance;
    /**
     * Registers a resource that is accessible using a CNAME.
     */
    registerCnameInstance(props: CnameInstanceBaseProps): IInstance;
}
/**
