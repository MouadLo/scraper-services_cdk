...
export declare abstract class NamespaceBase extends cdk.Construct implements INamespace {
    abstract readonly namespaceId: string;
    abstract readonly namespaceArn: string;
    abstract readonly namespaceName: string;
    abstract readonly type: NamespaceType;
    export(): NamespaceImportProps;
}
/**
...
export declare class Namespace {
     ...
     * Import a namespace
     */
    static import(scope: cdk.Construct, id: string, props: NamespaceImportProps): INamespace;
    private constructor();
}
