 ...
 */
export declare abstract class SecretBase extends Construct implements ISecret {
...
export declare class Secret extends SecretBase {
     ...
     */
    static import(scope: Construct, id: string, props: SecretImportProps): ISecret;
    readonly encryptionKey?: kms.IEncryptionKey;
    readonly secretArn: string;
     ...
     */
    addTargetAttachment(id: string, options: AttachedSecretOptions): AttachedSecret;
    export(): SecretImportProps;
}
/**
 ...
 * An attached secret.
 */
export declare class AttachedSecret extends SecretBase implements ISecret {
    readonly encryptionKey?: kms.IEncryptionKey;
    readonly secretArn: string;
